...
from ..montague_syntax import parser
...
def test_montague():
    # res = parser("montague ?t1 runs")
    # res = parser("montague every woman sees a man")
    # res = parser("montague a woman that eats sees a man that sleeps")
    res = parser("montague study reports voxel")
    parser("montague every voxel that a study reports is an activation")
    parser("montague every voxel that 'a' reports activates")
    parser("montague every voxel that a study that mentions a word that is 'pepe' reports activates")
    parser("montague every voxel that a study that reports no region reports activates")
    parser("montague every voxel that a study -that reports no region- reports activates")
