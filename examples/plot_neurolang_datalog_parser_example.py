...
with nl.environment as e:
    nl.execute_nat_datalog_program('''
    ans(name, region_1) :- destrieux(name, region_1),neurosynth_supramarginal(e.region_2),overlapping(e.region_1, e.region_2)
    ''')
    # res = nl.query(
